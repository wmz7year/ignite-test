package org.wmz7year.service.util;
...
/**
 * Utility methods to assist in working with the Externalizable interfaces. This
 * class is only used when running inside of a Cluser. When using the open
 * source version this class will use a dummy implementation. Anyway, this class
 * is not used when not using the Enterprise edition.
 * <p>
 * 
 * ExternalizableLite is very similar to the standard Externalizable interface,
 * except that it uses DataOutput/DataInput instead of the Object stream
 * equivalents.
 * 
...
public class ExternalizableUtil {
	...
	private ExternalizableUtilStrategy strategy = new ClusterExternalizableUtil();
	...
	/**
	 * Writes a Map of String key and value pairs. This method handles the case
	 * when the Map is <tt>null</tt>.
	 * 
	 * @param out
	 *            the output stream.
	 * @param stringMap
	...
	/**
	 * Writes a Map of Long key and Integer value pairs. This method handles the
	 ...
	 *             if an error occurs.
	 */
	public void writeStringList(DataOutput out, List<String> stringList)
			throws IOException {
		strategy.writeStringList(out, stringList);
	}

	/**
	 * Reads a List of Strings. This method will return <tt>null</tt> if the
	 * List written to the stream was <tt>null</tt>.
	 * 
	 * @param in
	 *            the input stream.
	...
	/**
	 * Writes a collection of Externalizable objects. The collection passed as a
	 * parameter must be a collection and not a <tt>null</tt> value.
	 * 
	 * @param out
	 *            the output stream.
	 * @param value
	 *            the collection of Externalizable objects. This value must not
	 *            be null.
	 * @throws IOException
	 *             if an error occurs.
	 */
	...
	/**
	 * Writes a collection of Serializable objects. The collection passed as a
	 * parameter must be a collection and not a <tt>null</tt> value.
	 * 
	 * @param out
	 *            the output stream.
	 * @param value
	 *            the collection of Serializable objects. This value must not be
	 *            null.
	 * @throws IOException
	 *             if an error occurs.
	 */
	public void writeSerializableCollection(DataOutput out,
			Collection<? extends Serializable> value) throws IOException {
		strategy.writeSerializableCollection(out, value);
	}

	/**
	 * Reads a collection of Externalizable objects and adds them to the
	 * collection passed as a parameter. The collection passed as a parameter
	 ...
	 *            be null.
	 * @param loader
	 *            class loader to use to build elements inside of the serialized
	 *            collection.
	 * @throws IOException
	 *             if an error occurs.
	...
	/**
	 * Reads a collection of Serializable objects and adds them to the
	 * collection passed as a parameter. The collection passed as a parameter
	 * must be a collection and not a <tt>null</tt> value.
	 * 
	 * @param in
	...
	public int readSerializableCollection(DataInput in,
			Collection<? extends Serializable> value, ClassLoader loader)
			throws IOException {
	...
	/**
	 * Writes a Map of String key and Set of Strings value pairs. This method
	 * DOES NOT handle the case when the Map is <tt>null</tt>.
	 * 
	 * @param out
	 *            the output stream.
	 * @param map
	...
	/**
	 * Reads the string array from the input stream and adds them to the
